...
* Automatically reloads search results on orientation change.
* Used Card View to make look more presentable.
* Incorporated Shared preferences for storing the recent query.
* Implemented simple hashset logic to remove duplicate articles based on headline.
* ButterKnife to remove view lookups boilerplate.
* Hide keyboard for Dialog fragments.
## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/V4HLJKG.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
